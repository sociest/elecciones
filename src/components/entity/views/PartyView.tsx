  ...
  return (
    <main className="min-h-screen bg-neutral-white text-primary-green font-sans antialiased pb-24">
      ...
      <div className="max-w-6xl mx-auto px-6 -mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 relative z-20">
        <div className="bg-white p-8 rounded-[3rem] shadow-2xl shadow-primary-green/5 border border-primary-green/5 flex items-center gap-6 group hover:-translate-y-1 transition-transform">
          <div className="p-4 bg-primary-green/5 rounded-2xl text-primary-green group-hover:bg-primary-green group-hover:text-hunter transition-colors">
            <Calendar size={24} />
          </div>
          <div>
      ...
      <div className="max-w-6xl mx-auto px-6 mt-16 grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div className="lg:col-span-8 space-y-8">
          <div className="bg-white p-12 rounded-[4rem] shadow-xl border border-primary-green/5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <div>
                  ...
                  <h4 className="text-2xl font-black mb-6 group-hover:text-primary-green">
                    {presidenteName}
                  </h4>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-black bg-hunter px-3 py-1 rounded-lg border border-primary-green/10 uppercase tracking-widest">
                    Ver Perfil
                  </span>
                  <ArrowUpRight
                    size={16}
              ...
              <div className="p-8 bg-primary-green text-hunter rounded-[3rem] flex flex-col justify-center relative overflow-hidden">
                <Landmark
                  size={80}
          ...
          <div className="bg-white p-12 rounded-[4rem] shadow-xl border border-primary-green/5">
            ...
            <div className="p-8 bg-neutral-white border-2 border-dashed border-primary-green/10 rounded-[2.5rem] flex flex-col md:flex-row items-center gap-8 group hover:border-primary-green/30 transition-colors">
              <div className="w-16 h-16 bg-primary-green rounded-2xl flex items-center justify-center text-hunter shadow-lg shrink-0 group-hover:rotate-6 transition-transform">
                <Globe size={24} />
              </div>
        ...
        <aside className="lg:col-span-4 space-y-8">
          <div className="bg-hunter p-10 rounded-[3.5rem] border border-primary-green/10 shadow-sm relative overflow-hidden group">
            ...
            <Award className="absolute -right-8 -bottom-8 w-40 h-40 opacity-[0.03]" />
          </div>
          ...
          <div className="bg-primary-green text-hunter p-10 rounded-[3.5rem] shadow-2xl relative overflow-hidden group">
            ...
            <button className="w-full py-5 bg-hunter text-primary-green rounded-2xl font-black text-xs uppercase tracking-widest hover:scale-[1.02] active:scale-95 transition-all shadow-xl shadow-black/20 relative z-10">
              Consultar Transparencia
            </button>
            <Landmark className="absolute -right-10 -bottom-10 w-44 h-44 opacity-5 group-hover:rotate-12 transition-transform duration-1000" />
          </div>
        </aside>
      </div>
    </main>
