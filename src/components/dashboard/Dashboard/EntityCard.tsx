      ...
      <div>
        ...
        {hasParty && (
          <div className="flex items-center gap-3 py-2.5 px-4 bg-slate-50 rounded-2xl border border-slate-200 w-fit group-hover:bg-primary-green group-hover:text-white transition-colors">
            <div className="w-6 h-6 bg-orange-100 rounded-lg flex items-center justify-center text-[9px] text-orange-700 font-black border border-orange-200 group-hover:bg-white/20 group-hover:text-white group-hover:border-white/30 transition-colors">
